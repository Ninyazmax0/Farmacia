...
const initialUsuarios: Usuario[] = [
  { id: 1, nombre: 'Maria García', usuario: 'admin', contrasena: 'admin123', rol: 'administrador', activo: true, fecha_creacion: '2026-02-16' },
  { id: 2, nombre: 'Carlos López', usuario: 'vendedor1', contrasena: 'vendedor123', rol: 'vendedor', activo: true, fecha_creacion: '2026-02-16' },
  { id: 3, nombre: 'Ana Martínez', usuario: 'vendedor2', contrasena: 'vendedor123', rol: 'vendedor', activo: true, fecha_creacion: '2026-02-16' },
];
