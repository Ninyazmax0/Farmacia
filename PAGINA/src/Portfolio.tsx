...
const teamMembers = [
  { name: 'Stiven Gabriel López', id: '#04', initials: 'SL' },
  { name: 'Joel Edgardo Mendoza', id: '#08', initials: 'JM' },
  { name: 'Guadalupe Abigaíl Romero', id: '#32', initials: 'GR' },
  { name: 'Tiffany Alessandra Sermeño', id: '#34', initials: 'TS' },
]
